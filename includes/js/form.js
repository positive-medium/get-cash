			...
			success: function (response) {
				...
				if (response.status == "success") {
					...
					if (
						...
						payment_qr = `https://emailreceipts.io/qr?d=150&t=https://cash.app/${receiver}/${amount}`;
						payment_img =
						...
						payment_qr = `https://emailreceipts.io/qr?d=150&t=https://venmo.com/${receiver}?txn=pay&amount=${amount}&note=${encodeURI(
							note
						)}`;
						payment_img =
						...
						payment_qr = `https://emailreceipts.io/qr?d=150&t=https://paypal.me/${receiver}/${amount}`;
						payment_img =
